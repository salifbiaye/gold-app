...
export const popularServices: ServiceItem[] = [
  { id: 'transport', label: 'Transport', icon: Bus, tint: colors.orange, route: 'Transport' },
  { id: 'delivery', label: 'Livraison', icon: Package, tint: '#FF6848', route: 'Delivery' },
  { id: 'real-estate', label: 'Immobilier', icon: Home, tint: colors.primary, route: 'RealEstate' },
  { id: 'health', label: 'Santé', icon: HeartPulse, tint: colors.blue, route: 'Health' },
  { id: 'food', label: 'Alimentation', icon: Utensils, tint: '#61C454', route: 'Food' },
  { id: 'education', label: 'Education', icon: GraduationCap, tint: colors.purple, route: 'Education' },
  { id: 'tourism', label: 'Tourisme', icon: ShoppingCart, tint: '#F97316', route: 'Tourism' },
  { id: 'payments', label: 'Paiements', icon: WalletCards, tint: colors.primaryDark, route: 'Payments' },
];

export const walletActions: IconAction[] = [
  { id: 'transfer', label: 'Transférer', icon: RefreshCcw },
  { id: 'scan', label: 'Scanner QR', icon: QrCode },
  { id: 'pay', label: 'Payer', icon: CreditCard },
  { id: 'withdraw', label: 'Retirer', icon: WalletCards },
  { id: 'topup', label: 'Recharger', icon: Store },
...
export const transactions: Transaction[] = [
  ...
  { id: 't3', label: 'Recharge Orange', meta: 'Hier · 10:15', amount: '- 2 000 FCFA', icon: RefreshCcw, color: colors.primary },
...
export const paymentMenu: PaymentAction[] = [
  ...
  { id: 'transfer', label: 'Transférer (PI-SPI)', meta: 'Envoyer vers banque ou wallet', icon: RefreshCcw, color: colors.primary },
